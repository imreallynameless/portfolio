...
function Projects() {
  return (
    ...
    <Layout>
        ...
        <ProjectComponent
          title="Clear Vision"
          description = "An app that Uses AI to detect what type of trash is in front of the camera and tells the user how to dispose of it. Uses OpenCV and Tensorflow to detect what the current material in focus is, python to perform calculations, and webscokets for the real-time updates to the UI. A winner of Maker Con Challenger at Hack the Hill 2023 with over 100 category participants."
          image = {clearvision}
          url = "https://devpost.com/software/clean-vision"
          />
        <ProjectComponent
          title="Starry Stocks"
          description = "Uses real time data to display stock prices and volumes being traded with stars with the addition of anomalties which were any trade we found to be consider outliers. We have the consellations to  Uses websockets for the real-time , node/p5.js for backend/frontend respectively, and a little bit of statistics to display the data."
          image = {starrystocks}
